...
const MOCK_USERS = {
  'admin': { id: '1', name: 'مدير النظام', password: 'admin123', role: 'admin' as const },
  'staff': { id: '2', name: 'موظف المبيعات', password: 'staff123', role: 'staff' as const }
};
...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const login = async (username: string, password: string) => {
    ...
    try {
      ...
      localStorage.setItem('closetOrderUser', JSON.stringify(userWithoutPassword));
